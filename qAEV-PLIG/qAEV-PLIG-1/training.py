...
def train_NN(args):
    ...
    train_data = GraphDataset(root='data', dataset=dataset+'_train', y_scaler=None, coulomb_scaler=None)
    valid_data = GraphDataset(root='data', dataset=dataset+'_valid', y_scaler=train_data.y_scaler, coulomb_scaler=train_data.coulomb_scaler)
    test_data = GraphDataset(root='data', dataset=dataset+'_test', y_scaler=train_data.y_scaler, coulomb_scaler=train_data.coulomb_scaler)
    ...
    with open(scaler_file, 'wb') as f:
        pickle.dump({'y_scaler': train_data.y_scaler,
                     'coulomb_scaler': train_data.coulomb_scaler}, f)
